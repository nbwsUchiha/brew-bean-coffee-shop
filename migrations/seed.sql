...
from (values
  (
    ...
    'espresso-drinks', 550, null::integer, '/drinks/house-latte.jpg', 100, true,
  ...
  (
    ...
    'cold-coffee', 475, null::integer, '/drinks/cold-brew.jpg', 80, true,
    'Ethiopia', 'Dark', '16 oz'
  ),
  (
    ...
    'specialty', 625, 575, '/drinks/matcha-oat-latte.jpg', 60, true,
    'Japan', 'N/A', '12 oz'
  ),
  (
    ...
    'espresso-drinks', 525, null::integer, '/drinks/house-latte.jpg', 90, false,
    'Brazil', 'Medium', '8 oz'
  ),
  (
    ...
    'cold-coffee', 425, null::integer, '/drinks/cold-brew.jpg', 70, false,
  ...
  (
    ...
    'specialty', 595, null::integer, '/drinks/house-latte.jpg', 55, false,
    'Colombia', 'Medium', '12 oz'
  )
